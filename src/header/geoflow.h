...
//! I added this function for debugging to print the elem data 
void print_elem_data(Element *EmTemp, MatProps* matprops_ptr, FluxProps* fluxprops_ptr,
    TimeProps* timeprops_ptr);
...
extern "C" void predict_(double *Uvec, double *dUdx, double *dUdy,double *lap_phi,
...
extern "C" void correct_(double *Uvec, double *Uprev, double *fluxxp,
		...
		double *dUdx, double *dUdy, double *lap_phi, double *curv, double *intfrictang,
